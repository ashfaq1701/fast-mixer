...
FFMpegExtractorBak::FFMpegExtractorBak(const string &filePath, const AudioProperties targetProperties) {
    mFilePath = filePath.c_str();
    mTargetProperties = targetProperties;
}

int read(void *data, uint8_t *buf, int buf_size) {
    FFMpegExtractorBak *hctx = (FFMpegExtractorBak*)data;
...
bool FFMpegExtractorBak::createAVIOContext(uint8_t *buffer, uint32_t bufferSize,
...
bool
FFMpegExtractorBak::createAVFormatContext(AVIOContext *avioContext, AVFormatContext **avFormatContext) {
...
bool FFMpegExtractorBak::openAVFormatContext(AVFormatContext *avFormatContext, FILE* fl) {
...
bool FFMpegExtractorBak::getStreamInfo(AVFormatContext *avFormatContext) {
...
AVStream *FFMpegExtractorBak::getBestAudioStream(AVFormatContext *avFormatContext) {
...
bool FFMpegExtractorBak::decode() {
...
int64_t FFMpegExtractorBak::readData(
        uint8_t *targetData) {
    int returnValue = -1;
...
void FFMpegExtractorBak::printCodecParameters(AVCodecParameters *params) {
