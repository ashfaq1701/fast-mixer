...
extern "C" {
    void prepare_kotlin_recording_method_ids(JNIEnv *env) {
        jclass recordingVMClass = env->FindClass("com/bluehub/mixi/screens/recording/RecordingScreenViewModel");
    ...
    Java_com_bluehub_mixi_audio_RecordingEngine_create(JNIEnv *env, jclass, jstring recordingFileDir, jboolean  recordingScreenViewModelPassed) {
        if (!recordingEngine) {
    ...
    Java_com_bluehub_mixi_audio_RecordingEngine_delete(JNIEnv *env, jclass) {
        if (!recordingEngine) {
            return;
        }
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_setupAudioSource(JNIEnv *env, jclass, jint fd) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_startRecording(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_stopRecording(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT jboolean JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_startMixingTracksPlayback(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_stopMixingTracksPlayback(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT jboolean JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_startPlayback(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT jboolean JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_startPlaybackWithMixingTracks(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_startPlayingWithMixingTracksWithoutSetup(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_stopPlayback(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_pausePlayback(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_startLivePlayback(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_stopLivePlayback(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_flushWriteBuffer(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_restartPlayback(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_restartPlaybackWithMixingTracks(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    Java_com_bluehub_mixi_audio_RecordingEngine_getCurrentMax(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_resetCurrentMax(JNIEnv *env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT jint JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_getTotalSampleFrames(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT jint JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_getCurrentPlaybackProgress(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_setPlayHead(JNIEnv *env, jclass, jint position) {
        if (!recordingEngine) {
    ...
    JNIEXPORT jint JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_getDurationInSeconds(JNIEnv * env, jclass) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_addSources(JNIEnv *env, jclass, jobjectArray filePaths) {
        if (!recordingEngine) {
    ...
    JNIEXPORT void JNICALL
    Java_com_bluehub_mixi_audio_RecordingEngine_resetRecordingEngine(JNIEnv *env, jclass) {
        if (!recordingEngine) {
