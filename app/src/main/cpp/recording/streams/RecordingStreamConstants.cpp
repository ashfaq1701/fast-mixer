...
int32_t RecordingStreamConstants::mRecordingFramesPerCallback = 144;
int32_t RecordingStreamConstants::mLivePlaybackFramesPerCallback = RecordingStreamConstants::mRecordingFramesPerCallback;
